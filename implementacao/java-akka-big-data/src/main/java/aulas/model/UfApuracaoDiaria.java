...
public class UfApuracaoDiaria {
	private String estado;
	private Integer casos;
	private Integer mortes;
	private Integer recuperados;
	private String data;
	public UfApuracaoDiaria(String estado, Integer casos, Integer mortes, Integer recuperados,String data) {
		super();
		this.estado = estado;
		this.casos = casos;
		this.mortes = mortes;
