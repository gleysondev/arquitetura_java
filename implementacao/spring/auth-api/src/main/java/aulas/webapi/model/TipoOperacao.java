...
public enum TipoOperacao {
	...
	public static void perfilPermissao(Integer perfil, String funcionalidade) {
		for(TipoOperacao tp: TipoOperacao.values()) {
			System.out.println(String.format("INSERT INTO TAB_ACESSO_PERFIL_PERMISSAO(ID_PERFIL, ID_PERMISSAO)VALUES(%d, '%s_%s');", perfil, funcionalidade,tp.name() ));
		}
	}
