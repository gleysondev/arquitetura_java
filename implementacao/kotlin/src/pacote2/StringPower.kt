...
fun main(args: Array<String>) {
    ...
    println("O primeiro nome de ${nomeCompleto.toUpperCase()} é $primeiroNome") //interpolação
    ...
    var letras = sigla.toList()

    println("O byte da  $letra é ${letras.get(0)}") //interpolação
